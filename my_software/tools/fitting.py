...
def fit_hyperfine(frequency_array, voltage_array, feature_distance_in_Hz=0.5e6, feature_prominence=0.02,
    ...
    It is ment for high-quality hyperfine ODMR spectra, without much noise. AFter peak-finding, this function fits
    parabolas to the peaks and dips to more accurately determine their positions.
    ...
    Args:
        ...
        feature_fit_range: The range in Hz around the peaks and dips to fit parabolas
        plot_all:
    ...
    try:
        # for a Lorentzian, the linewidth would be sqrt(3) times the difference between the peak and dip positions
